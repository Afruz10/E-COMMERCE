...
export default function Header() {
  ...
  return (
    <>
      ...
      {/* 💎 Transparent Glass Capsule Floating Header */}
      <header
      ...
      >
        <div className="flex items-center justify-between gap-4 px-6 py-3">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              ...
              {hydrated && count > 0 ? (
                <span className="absolute -right-1 -top-1 flex h-4 min-w-4 items-center justify-center rounded-full bg-red-500 px-1 text-[0.6rem] font-extrabold text-white">
                  {count}
                </span>
              ) : null}
            </button>
        ...
        {menuOpen ? (
          <div className="absolute top-14 left-0 w-full rounded-3xl border border-white/10 bg-black/90 p-4 backdrop-blur-2xl lg:hidden shadow-2xl">
